...
function IsDarknessDetected() {
    if(darkestPoint.x < 100 && darkestPoint.y < 100) {
        ...
        darkestPoint.x > 720 && darkestPoint.y > 540 {
            return true;
        } else {
            return false;
        }
        ...
        darkestPoint.x > 720 && darkestPoint.y < 100 {
            return true;
        } else {
            return false;
        }
        ...
        darkestPoint.x < 100 && darkestPoint.y > 540 {
            return true;
        } else {
            return false;
        }
...
*/
        ...
        if (IsDarknessDetected(zoneTwo)) {
        print("LK2");
        //LK1_mp3.play();
        }
        
        if (IsDarknessDetected(zoneThree)) {
        print("LK3");
        //LK1_mp3.play();
        }
        
        if (IsDarknessDetected(zoneFour)) {
        print("LK4");
        //LK1_mp3.play();
        }
/*
